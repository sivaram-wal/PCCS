...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setStyles() {
        //NavBar Style
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedStringKey.font: UIFont.dinProBold(20), NSAttributedStringKey.foregroundColor: UIColor.black]
        ...
        //TextFields
        UITextField.appearance().tintColor = UIColor.sandyBrownColor()
        
        //TextViews
        UITextView.appearance().tintColor = UIColor.sandyBrownColor()
